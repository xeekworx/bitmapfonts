...
uint32_t renderer_base::select_foreground(uint32_t color)
{
...
uint32_t renderer_base::select_background(uint32_t color)
{
...
const xwf_font * renderer_base::select_font(const xwf_font * font, font_style style)
{
