...
namespace xeekworx {
    namespace bitmapfonts {
        ...
        protected:
            ...
            virtual void on_draw_line(const int32_t x1, const int32_t y1, const int32_t x2, const int32_t y2, const color& clr) = 0;
            virtual void on_draw_rect(const int32_t x, const int32_t y, const int32_t w, const int32_t h, const color& clr, const uint32_t thickness = 1) = 0;
            virtual void on_fill_rect(const int32_t x, const int32_t y, const int32_t w, const int32_t h, const color& clr) = 0;
