    ...
    namespace bitmap_fonts {
        ...
        private:
            ...
            struct pixel_bgra {
                ...
                uint8_t b, g, r, a;
                pixel_bgra() {}
                pixel_bgra(uint8_t b, uint8_t g, uint8_t r, uint8_t a) : b(b), g(g), r(r), a(a) {}
                pixel_bgra(const pixel_rgba& p) : b(p.b), g(p.g), r(p.r), a(p.a) {}
                pixel_bgra(const uint32_t& value) {
                    b = (value >> 24) & 0xFF;
                    g = (value >> 16) & 0xFF;
                    r = (value >> 8) & 0xFF;
                    a = value & 0xFF;
                }
                pixel_bgra(const uint32_t& value, const uint8_t& alpha) {
                    b = (value >> 24) & 0xFF;
                    g = (value >> 16) & 0xFF;
                    r = (value >> 8) & 0xFF;
                    a = alpha;//value & 0xFF;
